...
DIR = 'dataset/svhn/test'
ANNOTATION_FILE = "dataset/annotation/test/digitStruct.json"
...
if __name__ == "__main__":
    ...
    img_files = file_io.list_files(directory=DIR, pattern="*.png", recursive_option=False,
                                   n_files_to_sample=1000, random_order=False)
